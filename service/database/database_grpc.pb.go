...
type DatabaseClient interface {
	InsertTransaction(ctx context.Context, in *service.Transaction, opts ...grpc.CallOption) (*InsertTransactionResponse, error)
}
...
func (c *databaseClient) InsertTransaction(ctx context.Context, in *service.Transaction, opts ...grpc.CallOption) (*InsertTransactionResponse, error) {
...
type DatabaseServer interface {
	InsertTransaction(context.Context, *service.Transaction) (*InsertTransactionResponse, error)
...
func (UnimplementedDatabaseServer) InsertTransaction(context.Context, *service.Transaction) (*InsertTransactionResponse, error) {
...
func _Database_InsertTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DatabaseServer).InsertTransaction(ctx, req.(*service.Transaction))
	}
